...
import com.qgailab.raftkv.Consensus;
...
public class DefaultConsensus implements Consensus {
     ...
     */
    @Override
    public VoteResult requestVote(RequestVoteParam param) {
        try {
     ...
     */
    @Override
    public AppendResult appendEntries(AppendLogParam param) {
        ...
        try {
            ...
            if (param.getEntries() == null || param.getEntries().length == 0) {
                ...
                return AppendResult.newBuilder().term(node.getCurrentTerm()).success(true).build();
            }
